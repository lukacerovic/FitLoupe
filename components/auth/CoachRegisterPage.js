...
import { View, ScrollView, Modal, TextInput, StyleSheet, Alert, Image, Text, TouchableOpacity, Dimensions, Platform } from 'react-native';
...
const CoachRegisterPage = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    // Dodali smo proveru za Android uređaje
  ...
  return (
    <ScrollView style={{backgroundColor:'#181818'}}>
      <View style={styles.container}>
        ...
        <Formik initialValues={{ email: '', password: '', firstName: '', lastName: '' }} validationSchema={validationSchema} onSubmit={handleSubmit}>
